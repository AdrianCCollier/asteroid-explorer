  ...
  useLayoutEffect(() => {
    ...
    canvas.addEventListener('click', function (e) {
      ...
      if (distance1 < rad1) {
        ...
        // in order to link this asteroid to a phaser scene
    ...
    <div className="frontend__containers__canvas">
      ...
      {isMenuOpen && (
        <Menu
          ...
          asteroidInformation={asteroidInformation}
          closeMenu={closeMenu}
          clickedAsteroidIndex={clickedAsteroidIndex}
        />
      )}
    </div>
  )
